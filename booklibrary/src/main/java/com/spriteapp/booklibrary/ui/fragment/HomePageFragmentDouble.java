...
public class HomePageFragmentDouble extends BaseFragment implements View.OnClickListener {
    private View mView;
    ...
    private List<StoreBean> syTitles = new ArrayList<>();
    private List<StoreBean> shuTitles = new ArrayList<>();
    ...
    public void showpopWindow(View v) {
        ...
        popupWindow.showAsDropDown(v, 15, 5, Gravity.LEFT);
        viewClick(layout);
    }
